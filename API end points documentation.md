...
{
"orderId": "[ORDER_ID]",
"sessionId": "cs*test*..." // optional, uses order's transactionId if omitted
}
...
note : Updates a category. Requires admin role.
...
note : Creates a new subcategory under an existing category. Requires admin role.

# 47 - Get All SubCategories
...
note : Returns a single subcategory by its ID.

# 49 - Update SubCategory
